...
void LCD_Init(){
  ...
  LCDCR1_LCDSWAI = 0;     // whether LCD still workd under wait mode
  LCDCR1_LCDRPSTP = 0;    // whether LCD still workd under stop mode
...
//  fill_full_lcdram();
  ...
  LCDCR0_LCDEN = 1;   // enable LCD module
...
* digits 8 - 13.  Digit displays value passed in funtion call 
*
**********************************************************/
